...
patron_data = open('//CHFS/Shared Documents/OpenData/datasets/unpublished/patron_data.csv', 'w')
...
avg_age, blocked_patrons = create_csv(expired_patrons, total_age, patron_counter, blocked_counter)
